...
namespace Level.Presenter
{
    public class LevelPresenter : IDisposable
    {
        ...
        public LevelPresenter(ILevelView view, ILevelModel model, LevelConfig config)
        {
            _config = config;
            _view = view;
            _model = model;
        ...
        private void OnLevelStarted()
        {
            ...
            _disposables.Add(new PlayerPresenter(_model.Player, _view.CreatePlayerView(startPlayerPosition, _config)));
